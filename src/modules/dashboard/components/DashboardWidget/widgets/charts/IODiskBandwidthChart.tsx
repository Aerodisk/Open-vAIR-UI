...
const tPrefix = 'dashboard.widgets.ioDiskBandwidthMonitoringWidget'
...
export const IODiskBandwidthChart = defineComponent({
  name: 'IODiskBandwidthChart',
  data() {
    return { data: [] as BandWithData[] }
  },
  computed: {
    dataCurrent() {
      return this.$store.state.dashboard.data.disk_data
    },
  },
  watch: {
